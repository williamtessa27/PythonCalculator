...
root = Tk()
blank_space = " "
root.title (50 * blank_space + "Calculatrice")
root.resizable(width = FALSE, height = False)
root.geometry('438x573+400+300')
...
entDisplay = Entry(MainFrame, font=('arial', 18, 'bold'),bd=14, width=26, bg='cadet blue', justify=RIGHT)
...
btnClearAll = Button(MainFrame, width=6, height=2, font=('arial',16, 'bold'), bd=4, text=chr(67)+chr(69), bg='cadet blue'
                      ,command=added_value.all_Clear_Entry)
btnClearAll.grid(row=1, column=2, pady=1)

btnPM = Button(MainFrame, width=6, height=2, font=('arial',16, 'bold'), bd=4, text=chr(177), bg='cadet blue'
...
btnSin = Button(MainFrame, width=6, height=2, font=('arial',16, 'bold'), bd=4, text="Sin", bg='cadet blue'
...
btnSub = Button(MainFrame, width=6, height=2, font=('arial',16, 'bold'), bd=4, text="-", bg='cadet blue'
                , command=lambda:added_value.operation("sub"))
btnSub.grid(row=4, column=3, pady=1)

btnMul = Button(MainFrame, width=6, height=2, font=('arial',16, 'bold'), bd=4, text="*", bg='cadet blue'
                , command=lambda:added_value.operation("multi"))
btnMul.grid(row=5, column=3, pady=1)

btnDiv = Button(MainFrame, width=6, height=2, font=('arial',16, 'bold'), bd=4, text="/", bg='cadet blue'
                , command=lambda:added_value.operation("divide"))
btnDiv.grid(row=6, column=3, pady=1)

btnZero = Button(MainFrame, width=6, height=2, font=('arial',16, 'bold'), bd=4, text="0", bg='cadet blue'
                 , command=lambda:added_value.numberEnter(0))
btnZero.grid(row=6, column=0, pady=1)

btnDot = Button(MainFrame, width=6, height=2, font=('arial',16, 'bold'), bd=4, text=".", bg='cadet blue'
                , command=lambda:added_value.numberEnter("."))
btnDot.grid(row=6, column=1, pady=1)

btnEquals = Button(MainFrame, width=6, height=2, font=('arial',16, 'bold'), bd=4, text="=", bg='cadet blue'
